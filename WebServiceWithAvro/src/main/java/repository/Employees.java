...
public class Employees extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Employees\",\"namespace\":\"repository\",\"fields\":[{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"address\",\"type\":\"string\"},{\"name\":\"designation\",\"type\":\"string\"}]}");
   ...
   */
  public Employees(java.lang.CharSequence name, java.lang.CharSequence address, java.lang.CharSequence designation) {
    this.name = name;
